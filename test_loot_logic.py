...
def calculate_loot_distribution(loot_items, participant_count):
    ...
    for item_name, total_quantity in loot_summary.items():
        ...
        distribution[item_name] = {"total": total_quantity, "per_person": per_person, "remainder": remainder}
...
def test_distribution():
    ...
    loot_items = [{"name": "Gold Coins", "quantity": 60}, {"name": "Magic Sword", "quantity": 3}]
    participants = 3
    ...
    loot_items = [{"name": "Dragon Scale", "quantity": 7}, {"name": "Health Potion", "quantity": 13}]
    participants = 4
